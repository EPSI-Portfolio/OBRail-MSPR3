...
- Name: health.spec.ts >> Page État du Service >> le lien Grafana est présent
- Location: tests\e2e\health.spec.ts:26:3
...
Call log:
  ...
  - waiting for locator('#grafana-link')
