...
- Name: trajets.spec.ts >> Page Liste des Trajets >> le filtre jour/nuit fonctionne
- Location: tests\e2e\trajets.spec.ts:21:3
...
Call log:
  - waiting for locator('#service-type-filter')
