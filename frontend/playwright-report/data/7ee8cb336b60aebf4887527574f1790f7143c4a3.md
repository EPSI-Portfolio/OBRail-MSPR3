...
- Name: health.spec.ts >> Page État du Service >> la dernière vérification s'affiche après le check
- Location: tests\e2e\health.spec.ts:31:3
...
Call log:
  ...
  - waiting for locator('#last-checked')
