...
- Name: trajets.spec.ts >> Page Liste des Trajets >> un clic sur une carte navigue vers le détail
- Location: tests\e2e\trajets.spec.ts:46:3
...
Call log:
  - waiting for locator('.trajet-card').first()
