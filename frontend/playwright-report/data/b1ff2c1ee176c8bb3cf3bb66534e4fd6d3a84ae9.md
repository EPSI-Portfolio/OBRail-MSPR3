...
- Name: stats.spec.ts >> Page Statistiques >> le graphique circulaire s'affiche
- Location: tests\e2e\stats.spec.ts:26:3
...
Locator: locator('#pie-chart-section')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pie-chart-section')
