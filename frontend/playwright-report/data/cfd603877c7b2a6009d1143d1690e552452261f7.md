...
- Name: health.spec.ts >> Page État du Service >> l'indicateur de statut s'affiche
- Location: tests\e2e\health.spec.ts:13:3
...
Locator: locator('#status-indicator')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#status-indicator')
