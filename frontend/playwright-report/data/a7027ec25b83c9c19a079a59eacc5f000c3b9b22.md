...
- Name: health.spec.ts >> Page État du Service >> la page état du service se charge correctement
- Location: tests\e2e\health.spec.ts:8:3
...
Locator: locator('#page-title-health')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#page-title-health')
