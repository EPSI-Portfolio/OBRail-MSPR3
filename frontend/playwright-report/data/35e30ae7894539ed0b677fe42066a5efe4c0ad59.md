...
- Name: stats.spec.ts >> Page Statistiques >> la page statistiques se charge correctement
- Location: tests\e2e\stats.spec.ts:8:3
...
Locator: locator('#page-title-stats')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#page-title-stats')
